...
import  com.xzy.forestSystem.mob.tools.network.BufferedByteArrayOutputStream;
...
public class Data {
    ...
    public static byte[] AES128Encode(String key, String text) throws Throwable {
        ...
        byte[] keyBytes = key.getBytes(StringEncodings.UTF8);
        byte[] keyBytes16 = new byte[16];
        System.arraycopy(keyBytes, 0, keyBytes16, 0, Math.min(keyBytes.length, 16));
        byte[] data = text.getBytes(StringEncodings.UTF8);
    ...
    public static byte[] AES128Encode(byte[] key, String text) throws Throwable {
        ...
        return AES128Encode(key, text.getBytes(StringEncodings.UTF8));
    }
    ...
    public static String AES128Decode(String key, byte[] cipherText) throws Throwable {
        ...
        return new String(AES128Decode(key.getBytes(StringEncodings.UTF8), cipherText), StringEncodings.UTF8);
    }
    ...
    public static String CRC32(byte[] data) throws Throwable {
        ...
        sb.append(String.format("%02x", Integer.valueOf(((byte) ((int) (value >>> 56))) & 255)));
        sb.append(String.format("%02x", Integer.valueOf(((byte) ((int) (value >>> 48))) & 255)));
        sb.append(String.format("%02x", Integer.valueOf(((byte) ((int) (value >>> 40))) & 255)));
        sb.append(String.format("%02x", Integer.valueOf(((byte) ((int) (value >>> 32))) & 255)));
        sb.append(String.format("%02x", Integer.valueOf(((byte) ((int) (value >>> 24))) & 255)));
        sb.append(String.format("%02x", Integer.valueOf(((byte) ((int) (value >>> 16))) & 255)));
        sb.append(String.format("%02x", Integer.valueOf(((byte) ((int) (value >>> 8))) & 255)));
        sb.append(String.format("%02x", Integer.valueOf(((byte) ((int) value)) & 255)));
        while (sb.charAt(0) == '0') {
