...
public class MobRSA {
    ...
    /* JADX DEBUG: Can't convert new array creation: APUT found in different block: 0x004c: APUT  
      (r2v0 'keys' java.math.BigInteger[] A[D('keys' java.math.BigInteger[])])
      (0 ??[int, short, byte, char])
      (r9v0 'e' java.math.BigInteger A[D('e' java.math.BigInteger)])
     */
