...
import com.xzy.forestSystem.hellocharts.model.Column;
...
public class ColumnChartRenderer extends AbstractChartRenderer {
    ...
    private void highlightColumnsForSubcolumns(Canvas canvas) {
        ColumnChartData data = this.dataProvider.getColumnChartData();
        processColumnForSubcolumns(canvas, data.getColumns().get(this.selectedValue.getFirstIndex()), calculateColumnWidth(), this.selectedValue.getFirstIndex(), 2);
    }
    ...
    private void highlightColumnForStacked(Canvas canvas) {
        ColumnChartData data = this.dataProvider.getColumnChartData();
        processColumnForStacked(canvas, data.getColumns().get(this.selectedValue.getFirstIndex()), calculateColumnWidth(), this.selectedValue.getFirstIndex(), 2);
    }
    ...
    private void highlightSubcolumn(Canvas canvas, Column column, SubcolumnValue columnValue, int valueIndex, boolean isStacked) {
        if (this.selectedValue.getSecondIndex() == valueIndex) {
            ...
            canvas.drawRect(this.drawRect.left - ((float) this.touchAdditionalWidth), this.drawRect.top, ((float) this.touchAdditionalWidth) + this.drawRect.right, this.drawRect.bottom, this.columnPaint);
