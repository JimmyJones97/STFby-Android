            ...
            if (key != null) {
                if (this.capacity > 0) {
                    ...
                    while (this.size >= this.capacity) {
                        n = this.tail;
                        if (n == null) {
                            MobLog.getInstance().m58w("size != 0 but tail == null, this must meet any mistake! fix me!!", new Object[0]);
                    ...
                    if (this.size == 0) {
                        ...
                        MobLog.getInstance().m58w("size != 0 but head == null, this must meet any mistake! fix me!!", new Object[0]);
                        this.tail = n;
                        this.size = 0;
                    }
                    this.head = n;
