...
public class ChartScroller {
    ...
    public boolean fling(int velocityX, int velocityY, ChartComputator computator) {
        ...
        this.scroller.abortAnimation();
        this.scroller.fling(startX, startY, velocityX, velocityY, 0, (this.surfaceSizeBuffer.x - computator.getContentRectMinusAllMargins().width()) + 1, 0, (this.surfaceSizeBuffer.y - computator.getContentRectMinusAllMargins().height()) + 1);
        return true;
    }
}
