...
public class MobViewPager extends ViewGroup {
    ...
    private void init(Context context) {
        this.scroller = new Scroller(getContext(), new Interpolator() { // from class:  com.xzy.forestSystem.mob.tools.gui.MobViewPager.1
        ...
        switch (action) {
            ...
            case 1:
                if (this.touchState == 1) {
                    ...
                    vt.computeCurrentVelocity(easrNativeJni.VERIFY_TEST_LICENSE_OK_PREFIX, (float) this.maximumVelocity);
